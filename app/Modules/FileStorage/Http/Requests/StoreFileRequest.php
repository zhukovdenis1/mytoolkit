...
use App\Modules\FileStorage\Validators\Rules\UserStorageIdRule;
...
class StoreFileRequest extends BaseFormRequest
{
    ...
    public function __construct()
    {
        ...
        $this->rules =  [
            'storage_id' => ['required', 'integer', new UserStorageIdRule],
            'private'  => 'required|boolean',
            'link'     => 'nullable|string|max:1024|url',
            'file'     => 'nullable|file|required_without:link', // Базовая проверка, детали в prepareForValidation
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('link') && $this->get('link') && !$this->hasFile('file')) {
