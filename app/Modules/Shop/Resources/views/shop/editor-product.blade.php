...
@if($product)
    ...
    <div>
        ...
        <span class="props-cons">
            @if(!empty($props))
                <span class="pc-item">
                    <span class="pc-title">Плюсы:</span>
                    <ul>
            ...
            @endif
                @if(!empty($cons))
                    <span class="pc-item">
                    <span class="pc-title">Минусы:</span>
                    <ul>
        ...
        <a class="detail" href="{{ route('detail', ['product' => $product, 'productHru' => $product->hru]) }}" target="_blank">Подробнее о товаре &raquo;</a>
    </div>
@elseif ($idAe)
        <div>
            <h3>{{ $title }}</h3>
            ...
            <a class="detail" href="{{ route('go', ['aid' => $idAe]) }}" target="_blank">Подробнее о товаре &raquo;</a>
        </div>
@endif
</div>
